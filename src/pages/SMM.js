...
const SMM = () => {
    ...
    const SmmFaq = [
        ...
        },
        {
          eventkey: 5,
          title:
            "Can social media marketing replace other forms of advertising?",
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="service-details__right">
                ...
                <div className="service-details__content">
                  <h3 className="service-details__title">SOCIAL MEDIA MARKETING (SMM)</h3>
                  <p className="service-details__text ">
                  As more and more brands are uplifting with social media advertising, you should understand how to use social media for marketing and advertising to potential customers and expand your conversion. The main objective of social media advertising is to generate new clients and increase your sales easily.  Social Media Marketing (SMM) is an asset to every business and it has opened up a whole new world of opportunities for entrepreneurs and audiences to connect with each other. <br/>
A global community of 350 million people is using Social Media. 21% grows by every year.  The best way to find your potential customers is through social media and are you using Social Media effectively?<br/>
Social media marketing isn’t difficult, it’s all about the action, engaging with your audience, and having a conversation. A crazy world of business is Social Media. It’s the best live platform to meet the whole world and to make your business more and more social. We give a shout for your business to serve the thirsty-consumer community who is spending 3 hours daily online. Guaranteeing to deliver an increased Brand Identity, Online reputation, and huge consumer base. As a reliable social media marketing in Kochi, we are your short code for a long success. Yes, we make you learn the art of overpowering a cut-throat online competition!<br/>

You can trust on Waywedesign for your social media presentation. <br/>                                                                            
Social Media Marketing involves reaching out to your audience through the platforms like Facebook, Instagram Twitter, Linked In, Pinterest, YouTube and various other platforms. It has proved to be the most cost-effective and it makes the communication cool and fast with your customers. Social Media doesn't only give you a wide coverage but it also helps in growing visibility, generating traffic, leads, and conversions. However, most importantly creating an engagement with your audience is the essential factor in social media. Discover the best platforms to invest your money for Ads and increase your sales.<br/>
Maybe you are wondering what your social media agency is doing from month-month. At Waywedesign, we collaborate with your in-house team to ensure your social platforms playing a major role in building a brand. At the end of the day, reporting is important when it comes to social media marketing.<br/>
Highlighting your brand through social media will help improve your company's reputation and goodwill. Our social media marketing methods usually have 3-6 month targets and schedules. We tend to work closely with marketing departments to know what campaigns are being planned and implemented. We will find which platforms are right for you and we run campaigns at an affordable rate as well as the precise targeting.<br/>
